...
] satisfies { id: string; label: string; href: string; icon: any; badge?: string; highlight?: boolean }[]
...
export default function LeftNav() {
  ...
  return (
    <>
      ...
      {/* Nav — hidden on mobile unless mobileOpen, always shown sm+ */}
      <motion.nav
                ...
                {badge !== undefined && (
                  <motion.span
                    ...
                    className={cn(
                      ...
                      collapsed ? 'absolute -top-0.5 -right-0.5 w-4 h-4 bg-danger text-white' : 'ml-auto px-1.5 py-0.5 bg-danger/20 text-danger min-w-[20px]',
                    )}
                  >
                    {badge}
                  </motion.span>
